...
export async function getTicketTypes(_req: Request, res: Response): Promise<Response> {
...
export async function getUserTicket(req: AuthenticatedRequest, res: Response): Promise<Response> {
  const { userId } = req;
